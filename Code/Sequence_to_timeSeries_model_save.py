...
import sys
sys.stdout = open('./output_model.txt', 'w')
...
if not os.path.exists("./models/" + model_name): os.mkdir("./models/" + model_name)
if not os.path.exists("./data/" + model_name): os.mkdir("./data/" + model_name)
np.save("data/" + model_name + "/" + "X_test.npy", X_test)
np.save("data/" + model_name + "/" + "y_test.npy", y_test)
learn.export("./models/" + model_name + "/" + "trained_model.pth")
